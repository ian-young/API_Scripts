...
application found.")
        ...
        if trust_level == '1':
            ...
            safe_names = [print_person_name(person_id, persons)
...
def check_plates(safe, to_delete, plates):
    ...
    :type safe: list
    :param to_delete: Plate sthat are marked to be deleted during the purge.
    :type to_delete: list
...
application found.")
        ...
        if trust_level == '1':
            ...
            safe_names = [print_plate_name(plate_id, plates)
