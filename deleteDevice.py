...
def login_and_get_tokens(username=USERNAME, password=PASSWORD, org_id=ORG_ID):
    ...
    # Handle exceptions
        ...
        raise customExceptions.APIExceptionHandler(e, response, "Log in")
...
def logout(x_verkada_token, x_verkada_auth, org_id=ORG_ID):
    ...
    # Handle exceptions
        ...
        raise customExceptions.APIExceptionHandler(e, response, "Logout")
...
def deleteCameras(x_verkada_token, usr, org_id=ORG_ID):
    ...
    # Handle exceptions
        ...
        raise customExceptions.APIExceptionHandler(e, response, "Cameras")
    ...
    def delete_sensor(device_dict):
        ...
        for device in device_dict:
            ...
            # Handle exceptions
                ...
                raise customExceptions.APIExceptionHandler(e, response, pline)
        ...
        for device_id in device_ids:
            if device_id not in processed_ids:
               ...
               # Handle exceptions
                    ...
                    raise customExceptions.APIExceptionHandler(
                        e, response, ptype)
...
def deletePanels(x_verkada_token, x_verkada_auth, usr,
    ...
    # Handle exceptions
        ...
        raise customExceptions.APIExceptionHandler(e, response, ptype)
